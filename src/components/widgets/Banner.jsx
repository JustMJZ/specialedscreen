  ...
  return (
    <>
      <div
        ...
        className="rounded-xl p-4 text-center cursor-pointer hover:opacity-90 shadow-lg h-full flex items-center justify-center"
      >
        <div
          ...
          <div className="fixed inset-0 flex items-center justify-center z-[9999] p-4">
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-4">
                ...
                <button
                  onClick={() => setTempFontSize(Math.max(12, tempFontSize - 4))}
                  className={`${getIconButtonClass('md', 'secondary')} font-bold`}
                >
                  A−
                </button>
                ...
                <button
                  onClick={() => setTempFontSize(Math.min(72, tempFontSize + 4))}
                  className={`${getIconButtonClass('md', 'secondary')} font-bold`}
                >
                  A+
                </button>
